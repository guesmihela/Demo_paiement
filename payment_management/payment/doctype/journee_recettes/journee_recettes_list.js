  frappe.listview_settings['Journee Recettes'] = frappe.listview_settings['Journee Recettes'] ||
  {
      ...
      function cloture_journees()
      {
         ...
         else
         {
           for(let doc of selected_docs)
           {
             ...
             {
               frappe.throw(__("Tous les Recettes sélectionnés doivent avoir l'état Non Cloturée"));
             }
           }
           ...
           for(var i = 0; i < selected_docs.length; i++)
           {
              ...
              frappe.db.get_doc("Journee Recettes", null, {"name": selected_docs[i]['name']})
              .then(doc => {
